...
public class RecyclerviewAdapter2 extends RecyclerView.Adapter<RecyclerviewAdapter2.ViewHolder> {
    private ArrayList<FinishedgoalResponse.Result> arrayList;
    private LayoutInflater layoutInflater;
    private Context context;

    public RecyclerviewAdapter2(ArrayList<FinishedgoalResponse.Result> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerviewAdapter2.ViewHolder holder, int position) {
        final FinishedgoalResponse.Result item = arrayList.get(position);
