...
public class CustomDialogDeleteGoal extends Dialog {
    ...
    //생성자 생성
    public CustomDialogDeleteGoal(@NonNull Context context, View.OnClickListener positiveListener, View.OnClickListener negativeListener) {
        super(context);
